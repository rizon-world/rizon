...
func (appKeepers *AppKeepers) GenerateKeys() {
	...
	appKeepers.keys = sdk.NewKVStoreKeys(
		...
		icahosttypes.StoreKey, wasm.StoreKey, tokenswaptypes.StoreKey, treasurytypes.StoreKey,
		icacontrollertypes.StoreKey, ibchookstypes.StoreKey, ibcfeetypes.StoreKey,
	)
