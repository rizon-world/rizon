...
import (
	...
	"github.com/rizon-world/rizon/app/params"
)

// NewRootCmd creates a new root command for simd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	encodingConfig := rizon.MakeTestEncodingConfig()
	initClientCtx := client.Context{}.
		...
		WithHomeDir(rizon.DefaultNodeHome).
		WithViper("RI")

	initClientCtx.Viper.SetEnvKeyReplacer(strings.NewReplacer(".", "_", "-", "_"))
...
func initAppConfig() (string, interface{}) {
	...
	return params.CustomConfigTemplate(), params.CustomAppConfig{
		Config:               *srvCfg,
		BypassMinFeeMsgTypes: rizon.GetDefaultBypassFeeMessages(),
	}
}
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		genutilcli.CollectGenTxsCmd(banktypes.GenesisBalancesIterator{}, rizon.DefaultNodeHome),
		genutilcli.GenTxCmd(rizon.ModuleBasics, encodingConfig.TxConfig, banktypes.GenesisBalancesIterator{}, rizon.DefaultNodeHome),
...
func queryCommand() *cobra.Command {
	...
	rizon.ModuleBasics.AddQueryCommands(cmd)
...
func txCommand() *cobra.Command {
	...
	rizon.ModuleBasics.AddTxCommands(cmd)
	cmd.PersistentFlags().String(flags.FlagChainID, "", "The network chain ID")
...
func (ac appCreator) newApp(
	...
	return rizon.NewRizonApp(
		logger, db, traceStore, true, skipUpgradeHeights,
		cast.ToString(appOpts.Get(flags.FlagHome)),
		cast.ToUint(appOpts.Get(server.FlagInvCheckPeriod)),
		ac.encCfg,
		rizon.GetEnabledProposals(),
		appOpts,
		wasmOpts,
